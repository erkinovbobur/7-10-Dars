...
const Profile = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto mt-[100px] via-blue-500 to-purple-600 p-8 rounded-xl shadow-lg">
      {
        user && (
          <Card className="w-full p-8 rounded-lg shadow-custom bg-white">
            <div className="flex justify-between items-center">
              <div className="flex items-center space-x-8">
                <Link to="/">
                  <Avatar
                    ...
                    src={user.photo_url ? user.photo_url :"https://media.istockphoto.com/id/1337144146/vector/default-avatar-profile-icon-vector.jpg?s=612x612&w=0&k=20&c=BIbFwuv7FxTWvh5S3vB6bkT0Qv8Vn8N5Ffseq84ClGI="}
                    className="ring-4 ring-gray-700 shadow-md"
                  />
                </Link>
              ...
              <div className="space-y-3 text-gray-600">
                ...
                <div className="flex items-center">
                  ...
                  <Link to="tel:+998904471907">+998 (90) 447 19 07</Link>
                </div>
              </div>
            </div>
