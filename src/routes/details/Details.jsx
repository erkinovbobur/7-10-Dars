    ...
    return (
        <Container>
            <div className="flex flex-col lg:flex-row gap-12 mt-[120px]">
                <div className="flex flex-col space-y-2 p-4 rounded-lg bg-gray-200 h-[500px] mt-[20px]">
                    {product_images.map((image, index) => (
                        <img
                            key={index}
                            src={image}
                            alt={`Product Thumbnail ${index + 1}`}
                            className={`w-[120px] h-[100px] object-cover rounded-lg shadow-lg cursor-pointer transition-transform transform hover:scale-105 
                                ${index === selectedImageIndex ? 'border-2 border-red-500' : ''}`}
                ...
                <div className="lg:w-1/2 flex flex-col justify-between">
                    ...
                    <div className="flex items-center space-x-4 mt-4">
                        ...
                        <Button
                            ...
                            className="bg-gray-200 hover:bg-gray-300"
                        />
                         <Button type="primary" size="large" className="w-full py-4 text-xl font-semibold">
